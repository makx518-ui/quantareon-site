...
(function() {
    ...
    const CONFIG = {
        ...
        // Кадр ≈ 32 мс, значит 34 ≈ 1.1 сек. ЭТО ЕГО ЧИСЛО, добытое за
        // полгода настройки ради ощущения живого разговора. 07.08 я поднял
        // его до 56, потом до 44 — он сразу услышал, что реалтайм пропал.
        // ВЕРНУЛ КАК БЫЛО и больше не трогаю: разрыв длинной фразы с паузой
        // лечится на сервере (AUTOFLUSH_SEC), а не здесь.
