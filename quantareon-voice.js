...
(function() {
    ...
    const CONFIG = {
        ...
        // Кадр ≈ 32 мс. Было 34 ≈ 1.1 сек: стоило задуматься посреди мысли
        // чуть дольше — и половина фразы уходила помощнику отдельно, а он
        // отвечал на огрызок. Ровно это и делал за нас Flux, только по
        // смыслу. 56 ≈ 1.8 сек — раздумье терпит, а ответ ждать не утомляет.
        // Меньше 40 — начнёт перебивать, больше 80 — ответ заметно тормозит.
        VAD_REDEMPTION_FRAMES: 56,
